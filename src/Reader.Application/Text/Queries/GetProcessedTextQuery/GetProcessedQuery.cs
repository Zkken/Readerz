...
namespace Reader.Application.Text.Queries.GetProcessedTextQuery
{
    public class GetProcessedTextQuery : IRequest<TextProcessingResult>
    {
        public string Text { get; set; }
         ...
         public class GetProcessedTextQueryHandler : IRequestHandler<GetProcessedTextQuery, TextProcessingResult>
         {
             ...
             public async Task<TextProcessingResult> Handle(GetProcessedTextQuery request, CancellationToken cancellationToken)
             {
